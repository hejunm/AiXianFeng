//
//  HEShopCarSuperMarketView.swift
//  AXF
//
...
class HEHeaderSuperMarketView: UIView {
    override init(frame: CGRect) {
        ...
        let marketTitleLabel = UILabel(frame: CGRectMake(CGRectGetMaxX(rocketImageView.frame) + 10, 5, width * 0.6, 20))
